      ...
      {isLoading ? (
        ...
        <div style={{ display: 'flex', gap: 32, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1, minWidth: 0, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {/* Link del menú */}
            <div style={{ borderRadius: 18, border: '1px solid #EFE7DF', background: '#fff', padding: '16px 20px' }}>
              <div style={{ fontFamily: sm, fontSize: 10, letterSpacing: '.08em', color: '#9a8f86', textTransform: 'uppercase', marginBottom: 10 }}>
                Link de tu menú público
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                <div style={{
                  flex: 1, display: 'flex', alignItems: 'center', gap: 10,
                  background: '#FBF8F5', border: '1.5px solid #E7DED6', borderRadius: 12,
                  padding: '10px 14px', minWidth: 0,
                }}>
                  <ExternalLink size={15} color="#9a8f86" style={{ flexShrink: 0 }} />
                  <span style={{ fontFamily: sm, fontSize: 12, color: '#5a5048', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                    {typeof window !== 'undefined' ? getMenuUrl(restaurant.slug) : `/${restaurant.slug}`}
                  </span>
                </div>
                <a
                  ...
                  style={{
                    ...
                    background: '#FBF8F5', border: '1.5px solid #E7DED6',
                    fontFamily: sg, fontSize: 13, fontWeight: 600, color: '#5a5048',
            ...
            <div style={{ overflow: 'hidden', borderRadius: 18, border: '1px solid #EFE7DF', background: '#fff' }}>
              <RestaurantForm
